...
DataManager.processOptimizeScriptCalls = function () {
  ...
  var length = commonEvents ? commonEvents.length : 0;
...
// Conditional Branch
Yanfly.OptSC.Game_Interpreter_command111 = Game_Interpreter.prototype.command111;
...
// Control Variable
Yanfly.OptSC.Game_Interpreter_command122 = Game_Interpreter.prototype.command122;
...
// Script Call
Yanfly.OptSC.Game_Interpreter_command355 = Game_Interpreter.prototype.command355;
