...
Imported.Galv_BustMenu_Modified = true;
...
//-----------------------------------------------------------------------------
/*:
 * @plugindesc Changes the default actor layout in the main menu to use. Modified to show bust according to equipment
...
(function () {
  Galv.BM.a = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Menu Actors']);
  Galv.BM.ar = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Menu Actor Rows']);
  Galv.BM.name = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Name'] - 1);
  Galv.BM.nickname = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Nickname'] - 1);
  Galv.BM.class = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Class'] - 1);
  Galv.BM.level = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Level'] - 1);
  Galv.BM.bars = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Bars'] - 1);
  Galv.BM.JP = Number(PluginManager.parameters('Galv_BustMenu_Modified')['JP'] - 1);
  Galv.BM.xp = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Exp Bar'] - 1);
  Galv.BM.xpBar =
    PluginManager.parameters('Galv_BustMenu_Modified')['Show Exp Bar'] == 'true' ? true : false;
  Galv.BM.xpText =
    PluginManager.parameters('Galv_BustMenu_Modified')['Show Exp Text'] == 'true' ? true : false;
  Galv.BM.xpLabel = PluginManager.parameters('Galv_BustMenu_Modified')['Exp Text'];
  Galv.BM.xpHeight = PluginManager.parameters('Galv_BustMenu_Modified')['Exp Bar Height'];
  Galv.BM.maxTxt = PluginManager.parameters('Galv_BustMenu_Modified')['Max Exp Text'];

  Galv.BM.xpCol1 = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Exp Bar Color 1']);
  Galv.BM.xpCol2 = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Exp Bar Color 2']);
  Galv.BM.icons = Number(PluginManager.parameters('Galv_BustMenu_Modified')['States'] - 1);
  Galv.BM.bust = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Bust Y']);
  Galv.BM.bustHeight = Number(PluginManager.parameters('Galv_BustMenu_Modified')['Bust Height']);
  Galv.BM.offsets = (function () {
    var array = PluginManager.parameters('Galv_BustMenu_Modified')['Bust Offsets'].split('|');
    var obj = {};
  ...
  Window_MenuStatus.prototype.drawActorSimpleStatus = function (actor, x, y, width) {
    ...
    if (Galv.BM.icons > -1) this.drawActorIcons(actor, x, y + lineHeight * Galv.BM.icons, width2);
  ...
  Game_Actor.prototype.xpRate = function () {
    return (
      (this.nextLevelExp() - this.currentExp()) / (this.nextLevelExp() - this.currentLevelExp())
    );
  };
  ...
  Window_MenuStatus.prototype.drawActorEXP = function (actor, x, y, width) {
    ...
    if (Galv.BM.xpText) {
      ...
      this.drawText(xprate > 0 ? Galv.BM.xpLabel : Galv.BM.maxTxt, x, y, width);
  ...
  if (Galv.BM.rmplugin) {
    ...
    Window_Base.prototype.drawExpGauge = function (x, y, width, rate, color1, color2) {
      ...
      if (outline) {
        this.contents.outlineTrap(x, gaugeY, width, barHeight, outlineColor1, outlineColor2);
      }
    };
  } else {
    // IF GALV ONLY
  ...
  Window_MenuStatus.prototype.drawFace = function (faceName, faceIndex, x, y, width, height) {
    ...
    const bustName = $lgcMgr.getBust(_.last(faceName));
