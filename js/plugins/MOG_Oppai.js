...
Game_CharacterBase.prototype.checkOppaiDataActor = function (actor) {
	...
	if (this._oppaiData.enabled != actor._oppaiData.enabled) {
		this._oppaiData.needRefresh = true;
	}
...
Sprite_Character.prototype.updateOppaiBase = function () {
	if (this.canCreateOppai()) {
		this.createOppaiSprites();
	}
	if (this.needRemoveOppaiSprite()) {
		this.removeOppaiSprite();
	}
	if (this._oppaiBody) {
...
Sprite_Character.prototype.needRefreshOppaiBitmap = function () {
	if (this._character._oppaiData.direction != this._character.direction) {
		return true;
	}
	return false;
};
...
Sprite_Character.prototype.canCreateOppai = function () {
	...
	if (!this._character._oppaiData.enabled) {
		return false;
	}
...
Sprite_Character.prototype.setOppaiFrame = function (sprite) {
	...
	if (this._character._oppaiData.outline) {
		this.drawOppaiOutline(sprite);
	}
};
...
// * set Tile Bitmap
//==============================
var _mog_oppai_sprtChar_setTileBitmap =
...
//==============================
var _mog_oppai_sprtChar_setCharacterBitmap =
...
Sprite_Character.prototype.updateOppaiBody = function (sprite) {
	if (!sprite.bitmap) {
		...
		if (this.needRefreshOppaiBitmap()) {
			this.setOppaiFrame(sprite);
		}
