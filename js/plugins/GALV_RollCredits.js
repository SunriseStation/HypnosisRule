...
(function () {
	Galv.CRED.skippable =
		PluginManager.parameters('Galv_RollCredits')['Skippable'].toLowerCase() ==
		'true'
			? true
			: false;
	Galv.CRED.bSkip =
		PluginManager.parameters('Galv_RollCredits')[
			'Block Skipping'
		].toLowerCase() == 'true'
			? true
			: false;
	Galv.CRED.titleText = PluginManager.parameters('Galv_RollCredits')[
		'Title Menu'
	];
	Galv.CRED.bgm = {
		name: PluginManager.parameters('Galv_RollCredits')['Title Credits Music'],
		pan: 0,
		pitch: 100,
		volume: 90,
	};
...
if (Galv.CRED.titleText != '') {
	Galv.CRED.Scene_Title_createCommandWindow =
	...
	Galv.CRED.Window_TitleCommand_makeCommandList =
